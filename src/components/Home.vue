<template>
	<div>
		...
		<!-- Jumbotron -->
		<div
			class="px-4 py-5 px-md-5 text-center text-lg-start fullscreen"
		...
		>
			...
			<!-- <div class="form-check mb-0">
										...
										<div class="text-center mt-4 pt-2">
											<router-link to="/teacher/dashboard"
												><button type="button" class="btn btn-primary btn-lg container-fluid mb-2">
													Login as Teacher
												</button></router-link
											>
			...
			<!-- <router-link to="/publisher/dashboard"
												><button type="button" class="btn btn-primary btn-lg container-fluid">
													Login as publisher
												</button></router-link
											> -->
			<!-- For now, log in will go to /teacher/dashboard. Just for testing -->
