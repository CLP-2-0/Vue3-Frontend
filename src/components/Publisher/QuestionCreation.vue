<template>
    <div class="">
      ...
      >
        ...
        <button v-if="isAdmin || isTeacher" type="button" class="btn btn-outline-success" @click="creationShow()"> {{ createBtn}}</button>
      </div>
      ...
      <div v-if="isExam && isTeacher" class="form-group row mt-2" :hidden="!show">
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input id="appt" v-model="examLength" placeholder="Ex: 2:15">
          </div>
      ...
      <div class="collapse" id="collapseQCreation" >
        <div class="q-creation">
          ...
          <div class="btn-container">
            ...
            <div class="modal fade" :id="['createSuccessNoti1' + type]" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <p>{{ message }}</p>
                <button type="button" class="btn btn-primary" @click="save" :disabled="disable">Create</button>
              </div>
              </div>
              </div>
              </div>
  ...
  <div class="container tab-adjuster">
          ...
          <div class="modal fade" :id="['createSuccessNoti' + type]" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              ...
              <div class="modal-footer">
                <p>{{ message }}</p>
                <button type="button" class="btn btn-primary" @click="create" :disabled="disable" >Create</button>
              </div>
            </div>
          </div>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      createSuccess() {
        this.message = "Your new question has been created. Close this window to see the new question list below."
        this.disable = true
