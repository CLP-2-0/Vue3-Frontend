                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" v-model="newLessons.LessonId" v-if="flagEdit==0" >
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary text-center" data-bs-dismiss="modal" v-if="flagEdit==0" @click="createLesson()" >Create</button>
                        <button type="submit" class="btn btn-primary text-center" data-bs-dismiss="modal" v-if="flagEdit==1" @click="updateLesson()" >Update</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <table class="table table-hover">
                ...
                <tr v-for="lesson in lessons" :key="lesson.id" >
                    ...
                    <td class="text-right"><div >
                        <button class="btn btn-light mx-3 " data-bs-toggle="modal" data-bs-target="#exampleModal" @click="editClick(lesson)">Edit</button>
...
export default {
    ...
    methods: {
        ...
        async updateLesson(){
            await axios.put("http://localhost:8000/lessons/"+this.newLessons.LessonId,
            {   id:this.newLessons.LessonId,
                title:this.newLessons.LessonTitle
            })
            .then((res) =>{
