  ...
  actions: {
                ...
                async function getUserData() {
                  try {
                    ...
                    localStorage.setItem(
                      "user_name",
                      checkUserInfo.data.data.username
                    );
                    localStorage.setItem(
                      "@email",
                      checkUserInfo.data.data.email
                    );
    ...
    auth0Logout(context) {
      ...
      window.location.href = `${
        import.meta.env.VITE_AUTH0_DOMAINURL
      }/v2/logout?returnTo=${import.meta.env.VITE_APP_DOMAINURL}&client_id=${
